	...
	<div class="w-full mx-auto">
		...
		<div class="bg-brand-red text-white p-8 sm:p-12  text-center relative overflow-hidden select-none">
			...
			<div class="relative z-10 max-w-2xl mx-auto">
				...
				<a href="<?php echo esc_url( home_url( '/doctors/' ) ); ?>" class="inline-flex items-center justify-center px-8 h-12 bg-white hover:bg-brand-cream text-brand-red text-xs font-bold rounded-[12px] shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5">
