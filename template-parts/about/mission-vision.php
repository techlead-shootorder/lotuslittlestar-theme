				...
				<div class="w-full">
					...
					<div class="flex items-center mb-8">
						...
						<div class="w-14 h-14 bg-brand-red/10 rounded-2xl flex items-center justify-center mr-4 shrink-0 select-none">
							<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-12 w-12">
								<defs>
									<style>.cls-1 { fill: #a61a24; } .cls-2 { fill: #f3e2dc; }</style>
								</defs>
								<rect class="cls-2" width="512" height="512" rx="51" ry="51"/>
								<g>
