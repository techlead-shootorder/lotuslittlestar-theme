...
<section class="py-16 bg-brand-cream border-b border-brand-cream relative">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
			...
			<div class="bg-white p-12 rounded-[1rem] shadow-sm hover:shadow-md transition-all duration-300 border border-brand-cream/40 flex flex-col items-center justify-center text-center">
			...
			<div class="bg-white p-12 rounded-[1rem] shadow-sm hover:shadow-md transition-all duration-300 border border-brand-cream/40 flex flex-col items-center justify-center text-center">
				...
				<span class="font-outfit text-3xl sm:text-4xl font-bold text-brand-green mb-3">150k+</span>
				<span class="text-xs sm:text-sm text-brand-green font-medium">Happy Patients</span>
			</div>
			...
			<div class="bg-white p-12 rounded-[1rem] shadow-sm hover:shadow-md transition-all duration-300 border border-brand-cream/40 flex flex-col items-center justify-center text-center">
				...
				<span class="font-outfit text-3xl sm:text-4xl font-bold text-brand-green mb-3">220+</span>
				<span class="text-xs sm:text-sm text-brand-green font-medium">Hospital Beds</span>
			</div>
