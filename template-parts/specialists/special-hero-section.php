...
<section class="relative bg-cover bg-center py-10 sm:py-24 border-b border-brand-cream/60 overflow-hidden" 
	style="background-image: url('http://lotuslittlestars.in/wp-content/uploads/2026/06/about-hero-banner.png');">
	...
	<div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
		...
		<div class="flex">
			<a href="#specialists-grid" 
				class="inline-flex items-center justify-center px-8 py-4 bg-brand-red hover:bg-brand-coral text-white text-sm sm:text-base font-bold rounded-xl shadow-md hover:shadow-lg transition-all duration-200">
