...
<div class="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-[#A61A24] rounded-t-2xl shadow-[0_-4px_20px_rgba(0,0,0,0.25)] border-t border-white/10 pb-safe">
	<div class="grid grid-cols-2 divide-x divide-white/20 py-0.5">
		<!-- Book Appointment Button -->
		<a href="#booking-form" class="flex flex-row items-center justify-around text-center px-2 py-1 text-white hover:bg-white/10 active:bg-white/20 transition-colors focus:outline-none group">
		...
		<!-- Call Button -->
		<a href="tel:+919666604444" class="flex flex-row items-center justify-around text-center px-2 py-1 text-white hover:bg-white/10 active:bg-white/20 transition-colors focus:outline-none group">
			<svg class="w-6 h-6 mb-1 text-white shrink-0 transform group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
