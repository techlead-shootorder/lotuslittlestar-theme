		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 pb-12 border-b border-brand-border">
			...
			<div class="flex flex-col gap-4">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="flex items-center">
					<img src="http://lotuslittlestars.in/wp-content/uploads/2026/06/lotus-logo-2-scaled.png" alt="Lotus Little Stars" class="h-16 w-22 object-contain">
				</a>
