		...
		<div class="flex items-center justify-between h-20">
			<div class="flex-shrink-0 flex items-center">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="flex items-center">
					<img src="http://lotuslittlestars.in/wp-content/uploads/2026/06/lotus-logo-2-scaled.png" alt="Lotus Little Stars" class="h-20 w-32 object-contain">
				</a>
			</div>
			...
			<div class="hidden md:flex items-center gap-3">
				...
				<a href="tel:+918585856556" class="inline-flex items-center justify-center gap-2 px-5 h-12 bg-white hover:bg-brand-cream text-brand-red border border-brand-red/30 hover:border-brand-red font-medium rounded-full shadow-sm hover:shadow-md transform hover:-translate-y-0.5 transition-all duration-200 text-sm">
	...
	<div class="hidden md:hidden bg-brand-bg border-b border-brand-cream" id="mobile-menu">
		<div class="px-4 pt-2 pb-4 space-y-2 font-medium text-base shadow-inner">
			...
			<div class="pt-4 pb-2 px-3 border-t border-brand-cream flex flex-col sm:flex-row gap-3">
				<a href="tel:+918585856556" class="w-full inline-flex items-center justify-center gap-2 px-6 h-12 bg-white hover:bg-brand-cream text-brand-red border border-brand-red/30 font-medium rounded-full shadow-sm transition-all text-sm">
					<svg class="h-4 w-4 text-brand-red shrink-0" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
						<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
					</svg>
					Call Now
